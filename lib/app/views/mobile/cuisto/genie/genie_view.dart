            ...
            children: <Widget>[
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text('Génie', style: Theme.of(context).textTheme.headline4),
                    UIHelper.verticalSpaceSmall(),
                    Text(
                      "Anything you need, deliverd. Pick-up, Drop or Buy anything, from anywhere in your city",
          ...
          Row(
            ...
            children: const <Widget>[
              _GenieCardView(
                title: 'Buy\nAnything',
                desc: 'Stationery\nMedicine\nGrocery\n& more',
                image: 'assets/image/delivery-boy.png',
              ),
              _GenieCardView(
                title: 'Pickup &\nDrop',
                desc: 'Lunchbox\nCharger\nDocuments\nClothes',
                image: 'assets/image/pizza-delivery-boy.png',
              )
            ],
          )
        ],
